...
namespace AddressSetRuntime
{
    ...
    struct AddressSet
    {
        ...
        uintptr_t EquipMotionDataTableImpl_ReadMotionDataTable2 = 0;
        uintptr_t EquipIdTableImpl_ReadPartsPackageInfoIndexTable = 0;
    ...
    inline const AddressSet& GetEnglishAddressSet()
    {
        static const AddressSet value =
        {
            ...
            0x1463B0060ull, // EquipMotionDataTableImpl_ReadMotionDataTable2
            0x140A2A750ull, // EquipIdTableImpl_ReadPartsPackageInfoIndexTable
    ...
    inline const AddressSet& GetJapaneseAddressSet()
    {
        static const AddressSet value =
        {
            ...
            0x0ull, // EquipIdTableImpl_ReadPartsPackageInfoIndexTable
