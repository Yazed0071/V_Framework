...
-- list of selectable headgear entries. headOptions / enableHead /
-- defaultSoldierFaceId / supportsHeadOptions are all PER-PT — each
-- playerType branch declares its own list.
--
...
-- enableHead=true on the branch so the framework keeps the face system
-- live for this outfit.
--==============================================================================
...
function this.OnAllocate()
    V_TppPlayer.AddOutfit{
        name = "MyMod:NeonSuitHeads",                                            -- Required

        snake = {
            partsPath = "/Assets/tpp/parts/chara/neon/neon_snake_v01.parts",      -- Required
            fpkPath   = "/Assets/tpp/pack/player/parts/neon_snake_v01.fpk",       -- Required

            headOptions = {                                                       -- Optional (Snake/Avatar can render BANDANA family)
                "NONE",
                "BANDANA",
                "INFINITE BANDANA",
                "BALACLAVA",
            ...
            enableHead = true,                                                    -- Optional (default false; set true for headless body)
            enableArm  = true,                                                    -- Optional (default true)
        },

        ddFemale = {
            partsPath = "/Assets/tpp/parts/chara/neon/neon_v01.parts",            -- Required
            fpkPath   = "/Assets/tpp/pack/player/parts/neon_v01.fpk",             -- Required

            headOptions = {                                                       -- Optional (DDFemale uses BALACLAVA family — BANDANA wouldn't render)
                "NONE",
                "BALACLAVA",
                "SP-HEADGEAR",
                "HP-HEADGEAR",
